...
import { Image as ImageType } from '@/models/space';
import { FaArrowLeft, FaArrowRight } from 'react-icons/fa';
import { MdCancel } from 'react-icons/md';

const SpacePhotoGallery: FC<{ photos: ImageType[] }> = ({ photos }) => {
      ...
      <div className='grid md:grid-cols-2 relative gap-5 px-3'>
        <div className='h-[540px] relative rounded-2xl overflow-hidden'>
          <div className='hidden md:flex justify-center items-center w-full h-full'>
            <Image
              src={photos[0].url}
              alt={`Space Photo ${currenPhotoIndex + 1}`}
          ...
          {remainingPhotosCount > 0 && (
            ...
            >
              <Image
                ...
                alt={`Space Photo ${maximumVisiblePhotos}`}
                className='img'
              />
...
export default SpacePhotoGallery;